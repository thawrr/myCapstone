<%@ Page Title="" Language="C#" MasterPageFile="~/Blackstone.Master" AutoEventWireup="True" CodeBehind="Search.aspx.cs" Inherits="CapstoneBlackstone.Search" %>
    ...
    <div id="SearchDiv">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <asp:TextBox ID="txtPrefSearchVentureDesc" runat="server" class="form-control"></asp:TextBox><br />
        ...
        <div class="row"><!--results row-->
            <div class="col-md-8 align-self-end"><!--all repeaters-->
                <h3>Search Results</h3><br />
                 &nbsp;&nbsp;&nbsp; <asp:Label ID="lblSearchError" runat="server" Font-Bold="True" Font-Size="Larger"></asp:Label><br />
